...
#include <mars_msgs/msg/ext_core_state.hpp>
#include <mars_msgs/msg/ext_core_state_lite.hpp>
#include <mars_msgs/msg/vision_sensor_state.hpp>
...
public:
  ...
  static inline mars::IMUMeasurementType ImuMsgToImuMeas(const sensor_msgs::msg::Imu& msg)
  {
  ...
  static inline mars_msgs::msg::ExtCoreState ExtCoreStateToMsg(const double& t, const mars::CoreStateType& core_state,
                                                         const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    mars_msgs::msg::ExtCoreState state_msg;
    state_msg.header.stamp = rclcpp::Time(static_cast<uint64_t>(t * 1e9));
  ...
  static inline mars_msgs::msg::ExtCoreState ExtCoreStateToMsgCov(const double& t, const mars::CoreStateType& core_state,
                                                            const mars::CoreStateMatrix state_cov,
                                                            const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    // Map States
    mars_msgs::msg::ExtCoreState state_msg(ExtCoreStateToMsg(t, core_state, frame_id));
  ...
  static inline mars_msgs::msg::ExtCoreStateLite ExtCoreStateLiteToMsg(const double& t, const mars::CoreStateType& core_state,
                                                                 const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    mars_msgs::msg::ExtCoreStateLite state_msg;
    state_msg.header.stamp = rclcpp::Time(static_cast<uint64_t>(t * 1e9));
    state_msg.header.frame_id = frame_id;
  ...
  static inline geometry_msgs::msg::PoseStamped ExtCoreStateToPoseMsg(const double& t, const mars::CoreStateType& core_state,
                                                                 const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    geometry_msgs::msg::PoseStamped pose_msg;
    pose_msg.header.stamp = rclcpp::Time(static_cast<uint64_t>(t * 1e9));
  ...
  static inline nav_msgs::msg::Odometry ExtCoreStateToOdomMsg(const double& t, const mars::CoreStateType& core_state,
                                                         const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    nav_msgs::msg::Odometry odom_msg;

    odom_msg.header.stamp = rclcpp::Time(static_cast<uint64_t>(t * 1e9));
  ...
  static inline nav_msgs::msg::Path BufferCoreStateToPathMsg(const double& t, const mars::Buffer& buffer,
                                                        const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    ...
    path_msg.header.stamp = rclcpp::Time(static_cast<uint64_t>(t * 1e9));
  ...
  static inline nav_msgs::msg::Odometry EigenVec3dToOdomMsg(const double& t, const Eigen::Vector3d& position,
                                                       const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    nav_msgs::msg::Odometry odom_msg;
  ...
  static inline mars::PositionMeasurementType PointMsgToPositionMeas(const geometry_msgs::msg::PointStamped& msg)
  {
  ...
  static inline mars::PositionMeasurementType PoseMsgToPositionMeas(const geometry_msgs::msg::PoseStamped& msg)
  {
  ...
  PoseWithCovMsgToPositionMeas(const geometry_msgs::msg::PoseWithCovarianceStamped& msg)
  {
  ...
  static inline mars::PositionMeasurementType TransformMsgToPositionMeas(const geometry_msgs::msg::TransformStamped& msg)
  {
  ...
  static inline mars::PositionMeasurementType OdomMsgToPositionMeas(const nav_msgs::msg::Odometry& msg)
  {
    const Eigen::Vector3d position(msg.pose.pose.position.x, msg.pose.pose.position.y, msg.pose.pose.position.z);
  ...
  static inline geometry_msgs::msg::PoseWithCovarianceStamped
  ...
  static inline geometry_msgs::msg::PoseWithCovarianceStamped PoseStateToPoseWithCovMsg(
  ...
  static inline geometry_msgs::msg::PoseStamped PoseStateToPoseMsg(const double& t,
  ...
  static inline mars::PoseMeasurementType PoseMsgToPoseMeas(const geometry_msgs::msg::PoseStamped& msg)
  {
    const Eigen::Vector3d position(msg.pose.position.x, msg.pose.position.y, msg.pose.position.z);
  ...
  static inline mars::PoseMeasurementType PoseWithCovMsgToPoseMeas(const geometry_msgs::msg::PoseWithCovarianceStamped& msg)
  {
    const Eigen::Vector3d position(msg.pose.pose.position.x, msg.pose.pose.position.y, msg.pose.pose.position.z);
  ...
  static inline mars::PoseMeasurementType TransformMsgToPoseMeas(const geometry_msgs::msg::TransformStamped& msg)
  {
    const Eigen::Vector3d position(msg.transform.translation.x, msg.transform.translation.y,
                                   msg.transform.translation.z);
  ...
  static inline mars::PoseMeasurementType OdomMsgToPoseMeas(const nav_msgs::msg::Odometry& msg)
  {
    const Eigen::Vector3d position(msg.pose.pose.position.x, msg.pose.pose.position.y, msg.pose.pose.position.z);
    const Eigen::Quaterniond orientation(msg.pose.pose.orientation.w, msg.pose.pose.orientation.x,
                                         msg.pose.pose.orientation.y, msg.pose.pose.orientation.z);
  ...
  static inline mars::VisionMeasurementType PoseMsgToVisionMeas(const geometry_msgs::msg::PoseStamped& msg)
  {
    const Eigen::Vector3d position(msg.pose.position.x, msg.pose.position.y, msg.pose.position.z);
    const Eigen::Quaterniond orientation(msg.pose.orientation.w, msg.pose.orientation.x, msg.pose.orientation.y,
                                         msg.pose.orientation.z);
  ...
  static inline mars::GpsMeasurementType NavSatFixMsgToGpsMeas(const sensor_msgs::msg::NavSatFix& msg)
  {
  ...
  static inline mars::GpsVelMeasurementType NavSatTwistWithCovMsgToGpsVelMeas(
      const sensor_msgs::msg::NavSatFix& msg_coord, const geometry_msgs::msg::TwistWithCovarianceStamped& msg_vel)
  {
  ...
  static inline mars::GpsVelMeasurementType NavSatTwistMsgToGpsVelMeas(const sensor_msgs::msg::NavSatFix& msg_coord,
                                                                       const geometry_msgs::msg::TwistStamped& msg_vel)
  {
  ...
  static inline geometry_msgs::msg::PoseWithCovarianceStamped GpsStateToMsg(const double& t,
  ...
  static inline geometry_msgs::msg::PoseWithCovarianceStamped GpsVelStateToMsg(
  ...
  static inline mars::MagMeasurementType MagMsgToMagMeas(const sensor_msgs::msg::MagneticField& msg)
  {
  ...
  static inline geometry_msgs::msg::PoseWithCovarianceStamped MagStateToMsg(const double& t,
  ...
  static inline mars::PressureMeasurementType FluidPressureMsgtoPressureMeas(const sensor_msgs::msg::FluidPressure& msg,
  ...
  FluidPressureMsgtoPressureMeas(const sensor_msgs::msg::FluidPressure& msg_press, const sensor_msgs::msg::Temperature& msg_temp)
  {
    return mars::PressureMeasurementType(msg_press.fluid_pressure, msg_temp.temperature);
  }

  static inline geometry_msgs::msg::PoseStamped PressureStateToMsg(const double& t,
  ...
  static inline geometry_msgs::msg::Vector3Stamped EigenVec3dToVec3Msg(const double& t, const Eigen::Vector3d& vec,
                                                                  const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    geometry_msgs::msg::Vector3Stamped vec_msg;
    vec_msg.header.stamp = rclcpp::Time(static_cast<uint64_t>(t * 1e9));
  ...
  static inline mars_msgs::msg::VisionSensorState VisionStateToMsg(const double& t,
                                                             const mars::VisionSensorStateType& vision_state,
                                                             const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    mars_msgs::msg::VisionSensorState vision_msg;
    vision_msg.header.stamp = rclcpp::Time(static_cast<uint64_t>(t * 1e9));
    ...
    vision_msg.lambda_value = vision_state.lambda_;
...
public:
  ...
  inline nav_msgs::msg::Path ExtCoreStateToPathMsg(const double& t, const mars::CoreStateType& core_state,
                                              const std::string& frame_id = DEFAULT_FRAME_ID)
  {
    nav_msgs::msg::Path path_msg;
    path_msg.header.stamp = rclcpp::Time(static_cast<uint64_t>(t * 1e9));
